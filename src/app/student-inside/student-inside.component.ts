...
@Component({
  selector: 'app-student-inside',
  templateUrl: './student-inside.component.html',
  styleUrls: ['./student-inside.component.scss'],
  imports: [CommonModule,FormsModule]
})

export class Studentinside implements OnInit {
